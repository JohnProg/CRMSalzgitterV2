	...
	export class GetBaseQuote_Result extends TCRMEntity {
		aDA: Date;
		aSign: string;
		asImporter: boolean;
		bLDate: Date;
		...
		bookingDate: Date;
		cDPCity: string;
		cDPCityDescription: string;
		cDPColonyName: string;
		cDPContact: string;
		cDPCountryDescription: string;
		cDPCountryName: string;
		cDPName: string;
		cDPStateDescription: string;
		cDPStateName: string;
		cDPStreet: string;
		cDPTelephone: string;
		cDPZipCode: string;
		...
		currencyName: string;
		custCity: string;
		custCityDescription: string;
		custCountryDescription: string;
		custCountryName: string;
		custDelivIdColony: number;
		custNumber: string;
		customerContactCellPhone: string;
		customerContactEmail: string;
		customerContactName: string;
		customerName: string;
		customerNickName: string;
		customerRFC: string;
		custStateDescription: string;
		custStateName: string;
		custStreet: string;
		dateCreated: Date;
		dateReceived: Date;
		dateSend: Date;
		deliveryLocation: string;
		doctTypeDescription: string;
		docTypeName: string;
		eTA: Date;
		eTD: Date;
		idContact: number;
		...
		idTypeOpp: number;
		idUser: number;
		incoTermDeliveredRequired: boolean;
		...
		isAutomotive: boolean;
		lastUpdated: Date;
		linerTermDescription: string;
		linerTermName: string;
		listStatus: string;
		...
		phone: string;
		pOCDateSend: Date;
		pOCDateSendedBy: string;
		pONumber: string;
		portDescription: string;
		portName: string;
		quoteNotes: string;
		quoteResponsibleCellPhone: string;
		quoteResponsibleEMail: string;
		quoteResponsibleName: string;
		quoteResponsibleOfficePhone: string;
		...
		taxAmount: number;
		total: number;
		transactionFlowDescription: string;
		transactionFlowName: string;
		typeOppDescription: string;
		typeOppName: string;
		vesselName: string;
